...
video = "https://t.me/c/2211216671/43"
local list = Redis:smembers(Fast.."total")
local JABWA = "*✭ عدد مشتركين بوتك『 "..#list.." 』مشترك*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '✭ سورس ارتـيكس ✭', url = 't.me/OE_YT '},
},
{
{text = '✭ مطور الصانع ✭', url = 't.me/H_H_H_P '},
},
}
...
local UserId_Info = LuaTele.searchPublicChat("H_H_H_P")
...
local TestText = "*✯ مبرمج سورس احـمـد ✭\n✯ ɴᴀᴍᴇ  >* ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n*✯ ʙɪᴏ -> "..Bio.." *"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = username, url = "https://t.me/H_H_H_P"}
},
}
...
local T =[[
☆︙[𝑊𝐸𝐿𝐶𝑂𝑀𝐸 𝑇𝑂 𝑆𝑂𝑈𝑅𝐶𝐸 𝐴𝑅𝑇𝐸𝑋](t.me/OE_YT )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '• مبرمج السورس •', url = 't.me/H_H_H_P '},
},
{
{text = '• تنصيب بوت مدفوع •', url = 't.me/H_H_H_P'},
},
{
{text = '• قناة التحديثات •', url = 't.me/OE_YT '},
},
{  
