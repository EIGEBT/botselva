...
elseif tonumber(Message_Edit.sender_id.user_id) ==  6475231729 then
data.The_Controller = 1
...
{{text = ' 𝙰𝙷𝙼𝙴𝙳 ⌔   𝚂𝙾𝚄𝚁𝙲𝙴', url = "https://t.me/OE_YT"}},
}
}
...
{
{text = '⌁ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗧𝗘𝗫⚡', url = 't.me/OE_YT'}, 
},
}
}
...
if Text and Text:match('(%d+)/play_wheel') then
  ...
  keyboard.inline_keyboard = {
  {
  {text = '✦ َ𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗧𝗘𝗫✦',url="t.me/OE_YT"}, 
  },
  }
  local msg_reply = msg_id/2097152/0.5
...
{
{text = ' 𝙰𝙷𝙼𝙴𝙳 ⌔  𝚂𝙾𝚄𝚁𝙲𝙴', url="t.me/OE_YT"},
},
}
}
...
msalm = "⌔ وسوينا لك حساب في بنك ارتـيكـس 🏦\n⌔ وشحنالك 50 جنيه 💵 هدية\n\n⇜ رقم حسابك ↢ ( `"..cccall.."` )\n⇜ نوع البطاقة ↢ ( "..ccctype.." )\n⇜ فلوسك ↢ ( 50 جنيه 💵 )\n⇜ شخصيتك : "..shakseshakse.."\n⇜ دولتك : 🇸🇾"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if tonumber(IdUser) ==  6475231729 then
data.The_Controller = 1
elseif tonumber(IdUser) ==  6475231729 then
data.The_Controller = 1
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/R_oO_sS_e/63", caption = "يلا بنا نبحث عن منزل",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
type = "photo",
media = ph,
caption = '*  *[آهــلٓآ بَٰــڪ فٍُــيَ س๋͜‏ــۄرس๋͜‏ ارتـيكـس 🕷️🔥](t.me/OE_YT)*\n\n*[ آقٍُـۄيَ مــصَٰـآنــعَِٰ س๋͜‏ــۄࢪس๋͜‏ــآټِٖ عَِٰــلٓيَ آلٓټِٖـلٓيَـج ـࢪآم](t.me/OE_YT) *\n\n*[ س๋͜‏ؤࢪس๋͜‏ ارتـيكـس عَِٰلٓيَ منعَِٰ ټِٖصَٰفٍُيَه آلٓمج ـمۄعَِٰآټِٖ ۄح ـمآيَټِٖهآ](t.me/OE_YT)*\n\n*[ لٓــديَــنــآ ټِٖـنصَٰيَــبَٰ بَٰـۄټِٖــآټِٖ مــيَـۄزڪ آيَــضَِٖـآ](t.me/OE_YT)*\n\n*[لٓديَــنآ ټِٖنـصَٰيَــبَٰ ح ـس๋͜‏ــآبَٰــآټِٖ ټِٖــلٓيَــثُِٖــۄن](t.me/OE_YT) *\n\n*[آلٓس๋͜‏ۄࢪس๋͜‏ مزۄد بَٰج ـميَعَِٰ آلآلٓعَِٰآبَٰ ۄآلٓمميَزآټِٖ آلٓمټِٖطِٖۄࢪه](t.me/OE_YT) *\n\n*[ټِٖآبَٰعَِٰ قٍُنآه آلٓټِٖح ـديثُِٖآټِٖ ۄآلٓټِٖطِٖۄيَࢪآټِٖ لٓيَصَٰلٓڪ ڪلٓ ج ـديَد لٓديَنآ](t.me/OE_YT) *\n\n*',
parse_mode = "Markdown"                                                                                                                                                               
}     
keyboard = {} 
keyboard.inline_keyboard = {
...
type = "photo",
media = ph,
caption = '[ 𖥔━═━═━═━ٰٰ𓆩⸤ 𝙰𝚁𝚃𝙴𝚇⸥𓆪═━═━═━𖥔 ](t.me/H_H_H_P) \n [ 🤖┇⌯ ⋆⃟➼ 𝙰𝙷𝙼𝙴𝙳 𝚂𝙾𝚄𝚁𝙲𝙴 ꕸ ˹🕷️🔥˼⁩](t.me/OE_YT) \n [ ⚙️┇⌯ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ](t.me/HS_DC) \n [ 🏑┇⌯ [˚₊· ͟͟͞͞➳❥❬ ғɪʟᴇs 𝚁𝚉 𝚂𝙾𝚄𝚁𝙲𝙴 ❭⌔ °](t.me/H_H_H_P) \n [ 🏅┇⌯ ⌔ !! 𝙳𝙴𝚅 𝚂𝙾𝚄𝚁𝙲𝙴ᵛ͢ᵎᵖ ](t.me/H_H_H_P) \n [𖥔━═━═━═━ٰٰ𓆩⸤ 𝙰𝙷𝙼𝙴𝙳⸥𓆪═━═━═━𖥔](t.me/OE_YT) \n [𖥔 𝑻𝑯𝑬 𝑩𝑬𝑺𝑻  𝑺𝑶𝑼𝑹𝑪𝑬 ⏎](t.me/OE_YT) \n\n',
parse_mode = "Markdown"                                                                                                                                                               
}     
keyboard = {} 
keyboard.inline_keyboard = {
...
type = "photo",
media = ph,
caption = '*  *[ 🎧╢⌔ لأستخدام البوت اغاني وفيديو كول](t.me/OE_YT)*\n*[ 🎥╢⌔ اكتب » /music ثم أضغط الأوامر](t.me/OE_YT) *\n*[ 🕹╢اكتب /key لاظهار كيبورد الاعضاء](t.me/OE_YT)*\n*[ 🌐╢⌔ وظيفتي حماية المجموعات](t.me/OE_YT)*\n*[ ✅╢⌔ لتفعيل البوت عليك اتباع مايلي](t.me/OE_YT) *\n*[ 🔘╢⌔ أضِف البوت إلى مجموعتك](t.me/OE_YT) *\n*[ ⚡️╢⌔ ارفعهُ » مشرف + اكتب تفعيل](t.me/OE_YT) *\n*[ ⬆️╢⌔ سيتم ترقيتك مالك في البوت](t.me/OE_YT) *\n*[ 🚨╢⌔ لكي أعمل معك بشكل صحيح](t.me/OE_YT) *\n*[ 📣╢⌔ تأكد » من اعطائي حذف الرسائل](t.me/OE_YT) *\n*[ 📣╢⌔ تأكد » من تفعيل الألعاب](t.me/OE_YT) *\n*[ 📣╢⌔ تأكد » من تفعيل الرفع](t.me/OE_YT) *\n*[ 📣╢⌔ تأكد » من تفعيل ردود السورس](t.me/OE_YT) *\n\n*',
parse_mode = "Markdown"                                                                                                                                                               
}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/R_oO_sS_e/63", caption = "⌔ في صوت هل صدر من الامام ام الخلف🧟‍♀️",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/R_oO_sS_e/63", caption = "⌔ هيا بنا نذهب الي الامام لنرا المنزل🧟‍♀️",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/R_oO_sS_e/63", caption = "هيا بنا نذهب الي الخلف لنري المنزل",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/R_oO_sS_e/63", caption = "⌔ لقد وصلنا الى المنزل شكراَ جزيلَ انتطرني ثواني وسوف اعود🧟‍♀️",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/R_oO_sS_e/63", caption = "⌔ لقد عودت إليك ظهر شيئ🧟‍♀️",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/R_oO_sS_e/63", caption = "⌔ ⌔ هيا نذهب داخل المنزل🧟‍♀️",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/R_oO_sS_e/63", caption = "⌔ نحن سنتوه في هذا المكان",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/R_oO_sS_e/63", caption = "لا يوجد ضواء في هذا المكان🧟‍♀️",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/R_oO_sS_e/63", caption = "تعالى نذهب الي الباب الرئيسي🧟‍♀️",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/R_oO_sS_e/63", caption = "انها النهاية هتكمل ولا لا🧟‍♀️",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/R_oO_sS_e/63", caption = "⌔ غلط القاب هوا-    تتصل على الوالده  و تقول لها تزوجت با سر⌔",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/R_oO_sS_e/63", caption = "⌔ غلط القاب هوا-    روح المطبخ و اكسر صحن او كوب⌔",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/R_oO_sS_e/63", caption = "⌔مبروك لقد فوزت ونجيت من العقاب⌔",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/R_oO_sS_e/63", caption = "⌔ غلط القاب هوا-    اذهب الى واحد ماتعرفه وقل له انا كيوت وابي بوسه🧟‍♀️",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/R_oO_sS_e/63", caption = "⌔ غلط القاب هوا-   خلاص سامحتك🧟‍♀️",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
if tonumber(IdUser) == tonumber(UserId) then
bann = {type = "photo", media = "https://t.me/R_oO_sS_e/63", caption = "⌔ غلط القاب هوا-    سكر خشمك و قول كلمة من اختيار الاعبين الي معك⌔",parse_mode = "Markdown"}     
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = ' المطور ', data = IdUser..'/helpsudo'},{text = '{ الالعاب }', data = IdUser..'/help6'}, 
},
{
...
{
{text = ' التسليه ', data = IdUser..'/helpts'},
},
{
{text = ' القائمه الرئيسيه ', data = IdUser..'/helpall'},
},
...
data = {
{
{text = '✦ َ𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗧𝗘𝗫✦', url = 't.me/'..chsource..''}, 
},
{
...
{
{text = ' ⸢ 𝒖𝒑𝒅𝒂𝒕𝒆 ⌔  𝒃𝒐𝒕 ⸥ ', url="t.me/OE_YT"},
},
}
}
local TextHelp = [[*
...
Textk = 'انت ⇿ ✂️\nسورس  ارتـيكـس ⇿ ✂️\nالنتيجة ⇿ سورس  ارتـيكـس ⚖️ '..bain..'\n✧'
elseif Descriptioont == "2" then
Textk = 'انت ⇿ ✂️\nسورس ارتـيكـس ⇿ 🪨️\nالنتيجة ⇿ 🏆 سورس ارتـيكـس 🏆\n✧'
else
Textk = 'انت ⇿ ✂️\nسورس ارتـيكـس ⇿ 📄️\nالنتيجة ⇿ 🏆 '..bain..' 🏆\n✧'
end
local reply_markup = bot.replyMarkup{
