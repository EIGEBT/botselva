...
xname =  (Redis:get(Fast.."Name:Bot") or "[ 𝙰𝙷𝙼𝙴𝙳]") 
...
data = {
{
{text = '✦ َ 𝐂𝐀𝐄𝐒𝐀𝐑• 𝙎َِ𝙊َِ𝙐َِ𝙍َِ𝘾َِ𝙀ِ ✦', url="t.me/OE_YT"},
},
}
}
...
bot.sendAudio(msg.chat_id,msg.id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@OE_YT")
sleep(1)
