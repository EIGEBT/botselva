...
chsource = Redis:get(Fast..'chsource') or "OE_YT"
devsource = Redis:get(Fast..'devsource') or "H_H_H_P"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,6475231729,6920192910,69200192910,7442990353,7442990353,555055555555,5555555555}
...
if UserId == 6475231729 then
Status = true
elseif UserId == 7442990353 then
Status = true
...
if UserId == 6475231729 then
Status = 'المبرمج احمد ❤️‍🔥'
elseif UserId == 6920192910 then
Status = 'مطـور السـورس '
elseif UserId == 7421491007 then
Status = 'مطـور السـورس '
elseif UserId == 64360417482 then
Status = 'مطـور السـورس '
elseif UserId == 7442990353 then
Status = ' ستك ملك يقلب امك ❤️‍🔥 '
elseif UserId == 7442990353 then
Status = 'مطـور السـورس '
elseif UserId == Sudo_Id then  
...
elseif UserId == 7442990353 then
Status = true
elseif UserId == 59860905034 then
Status = true
elseif UserId == 6276058332 then
Status = true
elseif UserId == Sudo_Id then  
Status = true
elseif Controll2 then
...
xname =  (Redis:get(Fast.."Name:Bot") or "[احمد]") 
...
if tonumber(senderr) == 6475231729 then
msg.Name_Controller = 'المبرمج احمد ❤️‍🔥  '
msg.The_Controller = 1
elseif tonumber(senderr) == 7421491007 then
msg.Name_Controller = 'مطور السورس - ✅ '
msg.The_Controller = 1
elseif tonumber(senderr) == 55555555555 then
msg.Name_Controller = 'مطور السورس - ✅ '
msg.The_Controller = 1
elseif tonumber(senderr) == 64309417482 then
msg.Name_Controller = 'مطور السورس - ✅ '
msg.The_Controller = 1
elseif tonumber(senderr) == 7442990353 then
msg.Name_Controller = 'ستك ملك يقلب امك 🌝🤍 '
msg.The_Controller = 1
elseif tonumber(senderr) == 59698971722 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
elseif tonumber(senderr) == 6276958332 then
msg.Name_Controller = 'مطـور السـورس  '
msg.The_Controller = 1
...
if msg.sender_id.user_id == tonumber(6475231729238) then
send(msg_chat_id,msg_id,"مرحبآ بك عزيزي المبرمج احمد نورت الجروب - 🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(7442990353) then
send(msg_chat_id,msg_id,"آهلا بيك عزيزتي المبرمجه ملك ملكه السورس ❤️‍🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(7442990353) then
send(msg_chat_id,msg_id,"آهلا بيك عزيزتي المبرمجه ملك السورس ❤️‍🔥","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
if msg.sender_id.user_id == tonumber(6475231729) then
send(msg_chat_id,msg_id," وسـع وسـع  مشاكس صاحب الابلكيشن وآلبــوت وآلسـورس وآهم شـخـصـيآت آلتلي يمـر - ✅","md",true)
end
end
if msg.content.Fastbots == "messageChatJoinByLink" or msg.content.Fastbots == "messageChatAddMembers" then
...
if idephoto then
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "[احمد]")
...
local name_amr = bot.getUser(6475231729).first_name.." "..bot.getUser(6475231729).last_name
local name_parlo = bot.getUser(6475231729).first_name.." "..bot.getUser(6475231729).last_name
local caption = "اليك قائمه مطورين سورس احمد :"
if tonumber(UserId_Info.id) ~= 6475231729 then
...
data = {
{
{text = name_amr, data = msg.sender_id.user_id..'/DevShow@6475231729'},
},
{
{text = name_parlo, data = msg.sender_id.user_id..'/DevShow@6475231729'},
},
LocalDev
,
{
...
return send(msg.chat_id, msg.id,"الرابط خطأ \nارسل الرابط بالشكل ده كمثال : https://t.me/OE_YT ", 'md', true)
end
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(6475231729) then
...
if text == 'ملك' or text == 'مرات احمد' then
photo = "https://t.me/M_a_z8l"
local T =[[
[ٓ  دي ملك  يقلب امك مرات صاحب السورس يقلبي❤️‍🔥 ˼ 𓆪 𓆃](t.me/M_a_z8l )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '‹ 𝙼𝚁𝙰𝙴𝚃 𝚊𝚑𝚖𝚎𝚍 › .', url = "https://t.me/M_a_z8l"}
},
{
{text = ' ⛥𝚊𝚑𝚖𝚎𝚍⛥ ', url = "https://t.me/H_H_H_P"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'احمد' or text == 'المبرمج' then
photo = "https://t.me/H_H_H_P"
local T =[[
[ٓ  ᯓ 𓆩 ˹ †ø δølløω ძενεløρεƦ øδ †hε  ˼ 𓆪 𓆃](t.me/H_H_H_P )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '‹ ٰ𖣂 • BOT 𝚊𝚑𝚖𝚎𝚍 • 𖣂 ›', url = "https://t.me/eorcbot"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'كيرو' or text == 'المبرمح كيرو' then
photo = "https://t.me/Y_J_J_J"
local T =[[
...
keyboard.inline_keyboard = {
{
{text = '‹ ⇣ 𒅒• ᎷᏒ </> KERO •𒅒 ⇣ › .', url = "https://t.me/Y_J_J_J"}
},
{
{text = '‹ ٰ𖣂 • ᑕᕼ • 𖣂 ›', url = "https://t.me/eorcbot"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'دودو' or text == 'مرات كيرو' then
photo = "https://t.me/Y_Y_Y_D"
local T =[[
[ٓدي دودو  يقلب امك مرات صاحب السورس يقلبي❤️‍🔥 ](t.me/Y_Y_Y_D )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝑫 🎀 >>', url = "https://t.me/Y_Y_Y_D"}
},
{
{text = '𝙆𝙀𝙍𝙊 𝙀𝙡𝙎𝙝𝙖𝘽𝙧𝙖𝙬𝙮', url = "https://t.me/Y_J_J_J"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'ملكميين' or text == 'حصنقتيز' then
...
keyboard.inline_keyboard = {
{
{text = '‹ ٰ💸 ⇣ الاوامر البنكيه ⇣ 💸 › .', url = "https://t.me/R_oO_sS_e/52"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard.inline_keyboard = {
{
{text = '‹ ٰ☬ ⇣ اصنع بوتك الان ⇣ ☬ › .', url = "https://t.me/o_r_nbot"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'المبرمج' or text == 'احمد' or text  == 'المبرمج احمد' then
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local bains = bot.getUser(msg.sender_id.user_id)
if bains.first_name then
...
bot.sendText(6475231729,0,'*\n◉  مرحباً عزيزي المبرمج احمد \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِ𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗧𝗘𝗫━━━━⩺ \n◉  اسمه :- '..klajq..' \n◉  ايديه :-  : '..msg.sender_id.user_id..'\n◉  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'فتيمووفا' or text == 'نبننبنبز'  then
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
local bains = bot.getUser(msg.sender_id.user_id)
if bains.first_name then
...
bot.sendText(7442990353,0,'*\n◉  مرحباً ملك مطوره السورس \nشخص ما يحتاج الي مساعده\n⩹━━━━َِ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗧𝗘𝗫━━━⩺ \n◉  اسمه :- '..klajq..' \n◉  ايديه :-  : '..msg.sender_id.user_id..'\n◉  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'ملك' or text == 'مرات احمد'  then
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
...
bot.sendText(7442990353,0,'*\n◉  مرحباً عزيزتي ملك قلب احمد هناك \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِ𝗦𝗢𝗨𝗥𝗖𝗘 𝗔𝗥𝗧𝗘𝗫━━━━⩺ \n◉  اسمه :- '..klajq..' \n◉  ايديه :-  : '..msg.sender_id.user_id..'\n◉  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == "صورتي" then
...
if msg.sender_id.user_id == tonumber(6475231729) then
send(msg_chat_id,msg_id,"❍ انت احمد مطور السورس يقلبي🌚♥","md",true)
elseif msg.sender_id.user_id == tonumber(7442990353) then
send(msg_chat_id,msg_id,"❍ انتي ملك مطور السورس يقلبي🌚♥","md",true)
elseif msg.sender_id.user_id == tonumber(7421491007) then
send(msg_chat_id,msg_id,"❍ انت كريم  مطور السورس يقلبي🌚♥","md",true)
elseif msg.sender_id.user_id == tonumber(7442990353) then
send(msg_chat_id,msg_id,"انتي [ملك مرات احمد] يقلبي 🥺♥","md",true)
elseif msg.sender_id.user_id == tonumber(1213559434) then
send(msg_chat_id,msg_id,"❍ انت احمد بآشا مطور السورس يقلبي🌚♥","md",true)
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(6475231729) then
local txx = "\n"
...
{{text = '- 𝐒𝐎𝐔𝐑𝐂𝐄 𝗔𝗥𝗧𝗘𝗫 •', url = "https://t.me/OE_YT"}},
}
}
...
return send(msg_chat_id,msg_id,'\n⌯ مرحبا بك في السجل المدني الخاص بسورس 𝗔𝗥𝗧𝗘𝗫\nاكتب اسمك الان :',"md",true)  
end
...
keyboard.inline_keyboard = {
{
{text = 'قناة السورس',url="t.me/OE_YT"}
},
}
local msg_id = msg.id/2097152/0.5
...
keyboardd.inline_keyboard = {
{
{text = 'قناة السورس', url = "https://t.me/OE_YT"}
},
}
local msg_id = msg.id/2097152/0.5
...
bot.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@OE_YT")
sleep(1)
...
{
{text = ' اضغط لتنصيب بوتك 🧚🏻‍♀️', url = "https://t.me/o_r_nbot"}
},
{
...
if text == (Redis:get(Fast.."Name:Bot") or "احمد") then
local photo = bot.getUserProfilePhotos(Fast)
if photo.total_count > 0 then
local NamesBot = (Redis:get(Fast.."Name:Bot") or "احمد")
local Mostafa = {
'• مالك حبيبى 🥺',
...
if text == 'احمد' or text == 'مبرمج السورس' or text == 'caesar' then  
local UserId_Info = bot.searchPublicChat("H_H_H_P")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
local msg_id = msg.id/6475231729/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
else
...
keyboardd.inline_keyboard = {
{
{text = '❲ المبرمج احمد ❳', url = "https://t.me/H_H_H_P"}
},
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄 𝐴𝑅𝑇𝐸𝑋', url = "https://t.me/OE_YT"},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id .. '&text=' .. URL.escape(TestText).."&reply_to_message_id="..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
data = {
{
{text = '𓆩 ˹ [𝐒𝐎𝐔𝐑𝐂𝐄 𝐴𝑅𝑇𝐸𝑋] ˼ 𓆪', url = "https://t.me/OE_YT"}
},
}
}
bot.sendPhoto(msg.chat_id, msg.id, 'http://t.me/'..chsource..'', [[
[ٓ ˚₊· ͟͟͞͞➳❥❬ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 [𝙲𝙷] Caesar 𝚂𝙾𝚄𝚁𝙲𝙴 ❭• °](t.me/OE_YT )
]],"md", true, nil, nil, nil, nil, nil, nil, nil, nil, reply_markup)
end
if text == '/start' then
...
local Name_dev = bot.getUser(Sudo_Id).first_name
local UName_dev = bot.getUser(Sudo_Id).username
local CmdStart = '*\n⌔ أهلآ بك في بوت '..(Redis:get(Fast.."Name:Bot") or "[احمد]")..
...
'\n⌔ ارسل كلمة { /CAESAR } لاظهار الكيبورد '..
'\n ⌔ ⋮ مطور البوت -›{@'..UserSudo..'}*'
if photo.total_count > 0 then
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = ' اضف البوت إلي مجموعتك 🧚🏻‍♀️', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
}
local msgg = msg_id/2097152/0.5
